...
self.addEventListener("install", function (e) {
  ...
  if ("GET" === e.request.method) {
    ...
    var a = "/index.html";
    !t && "navigate" === e.request.mode && isPathWhitelisted([], e.request.url) && (n = new URL(a, self.location).toString(), t = urlsToCacheKeys.has(n)), t && e.respondWith(caches.open(cacheName).then(function (e) {
